<?php
  ...
  if(!isset($_SESSION['is_login']))
  {
    if(isset($_REQUEST['rEmail'])){
      ...
      $sql="SELECT r_email ,r_password FROM requester_login WHERE 
      r_email='".$rEmail."' AND r_password='".$rPass."'limit 1";
      $result=$conn->query($sql);
      if($result->num_rows==1)
      { 
        $_SESSION['is_login']=true;
        $_SESSION['rEmail']=$rEmail;
        echo"<script>location.href='Requester_profile.php'</script>";
      }
      else
      {
          ...
          <div class="row mt-4 mb-4">
            <div class="col-md-6 offset-md-3">
               ...
               <div class="text-center custom" ><i class="fas  fa-4x fa-user"></i></div>
                   ...
                   class="form-control" placeholder="Password" name="rPass"required >
                </div>
